...
public class BoardController {
   ...
   public String add(Board board) throws Exception{
      ...
      boardService.insertBoard(board); // 저장메소드 호출
   ...
   public byte[] BoardFileDown(String filename, String original,
         HttpServletResponse response) throws Exception {
		      ...
		      //Context-Disposition: attachment: 브라우저스 해당 Content를 처리하지 않고, 다운로드하게 됩니다.
   ...
   /*
    		/boards/1, /boards/2... 처럼 주소 일부분의 값이 바꾼는 경우 {템플릿변수}로 표시하고
    		 이 값을 사용하기 위해 @PathVariable를 이용합니다.
    */
   
   
   @DeleteMapping("boards/{num}")
   public int BoardDeleteAction(
   ...
   public String BoardModifyAction(
	   ...
	   if (check != null && !check.equals(""))	{ // 기준파일 그대로 사용하는 경우입니다.
   ...
   public String BoardReplyAction(Board board) {
